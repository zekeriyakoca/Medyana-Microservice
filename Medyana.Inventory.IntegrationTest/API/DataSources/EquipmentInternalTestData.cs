...
namespace Medyana.Inventory.IntegrationTest.API.DataSources
{
  public class EquipmentInternalTestData
  {
    public static IEnumerable<object[]> EquipmentsToInsert
    {
      get
      {
        yield return new object[] { new EquipmentInsertDto { Name = "Test Equipment 1", ClinicId = 1, Price = 10, Quantity = 20, UsageRate = new decimal(1.2) }, true };
        yield return new object[] { new EquipmentInsertDto { Name = "Test Equipment 1", ClinicId = 1, Price = 10, Quantity = 20, UsageRate = new decimal(1.2) }, true };
        yield return new object[] { new EquipmentInsertDto { Name = "Test Equipment 1", ClinicId = 1, Price = new decimal(10000.324), Quantity = 120, UsageRate = new decimal(1.2) }, true };

        //yield return new object[] { new EquipmentInsertDto { Name = "Test Equipment 1", ClinicId = 12637, Price = 10, Quantity = 20, UsageRate = new decimal(1.2) }, true };
